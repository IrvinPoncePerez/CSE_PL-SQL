SELECT D.NUM_DEPARTMENT,
  ...
  FROM (SELECT HAPF.POSITION_ID,
               ...
               HAPF.FTE                 AS  "FTE",
               HAPF.EFFECTIVE_START_DATE    EFFECTIVE_START_DATE,
               HAPF.EFFECTIVE_END_DATE      EFFECTIVE_END_DATE
         ...
         WHERE FFVS.FLEX_VALUE_SET_NAME = 'XXCALV_DEPA'
           ...
           AND TO_DATE('01/' || :P_MONTH ||'/' || :P_YEAR, 'dd/mm/yyyy') BETWEEN HAPF.EFFECTIVE_START_DATE AND HAPF.EFFECTIVE_END_DATE
 ...
 WHERE 1 = 1
--   AND D.DEPARTMENT LIKE '%CAMPO QUINTA%'
--   AND D.POSITION LIKE '%GREENERO C-3%'
