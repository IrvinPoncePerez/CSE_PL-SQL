SELECT D.EARNINGS_PAYROLL_ACTION_ID, 
       D.EARNINGS_ASSIGNMENT_ID,
       D.EARNINGS_ELEMENT_NAME,
       D.EARNINGS_RESULT_VALUE,
       D.EARNINGS_RUN_RESULT_ID,
       D.EARNINGS_HOURS
  FROM (SELECT PAA.PAYROLL_ACTION_ID                AS  EARNINGS_PAYROLL_ACTION_ID, 
               PAA.ASSIGNMENT_ID                    AS  EARNINGS_ASSIGNMENT_ID,
