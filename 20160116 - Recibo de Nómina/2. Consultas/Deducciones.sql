SELECT D.DEDUC_PAYROLL_ACTION_ID, 
       D.DEDUC_ASSIGNMENT_ID,
       D.DEDUC_ELEMENT_NAME,
       D.DEDUC_RESULT_VALUE
  FROM (SELECT PAA.PAYROLL_ACTION_ID        AS  DEDUC_PAYROLL_ACTION_ID, 
               PAA.ASSIGNMENT_ID            AS  DEDUC_ASSIGNMENT_ID,
