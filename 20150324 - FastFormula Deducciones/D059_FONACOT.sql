...
/* ===== Latest balance creation begin ==== */
          ...
          SOE_ytd = D059_FONACOT_ASG_GRE_YTD
          SOE_mtd = D059_FONACOT_ASG_GRE_MTD
...
/* ====  Entry ITD Check Begin ==== */
   ...
   IF ( D059_FONACOT_ACCRUED_ENTRY_ITD = 0 AND
        D059_FONACOT_ACCRUED_ASG_GRE_ITD <> 0 ) THEN
   (
      to_total_owed = -1 * D059_FONACOT_ACCRUED_ASG_GRE_ITD + dedn_amt
   )

   IF ( D059_FONACOT_ARREARS_ENTRY_ITD = 0 AND
        D059_FONACOT_ARREARS_ASG_GRE_ITD <> 0 ) THEN
   (
      to_arrears = -1 * D059_FONACOT_ARREARS_ASG_GRE_ITD
   )
...
/* ===== Arrears Section Begin ===== */
   ...
   ELSE
   (
      IF D059_FONACOT_ARREARS_ASG_GRE_ITD <> 0 THEN
      (
         to_arrears = -1 * D059_FONACOT_ARREARS_ASG_GRE_ITD
      )
   )
   ...
   (
      ...
      ELSE
      (
         total_dedn = dedn_amt + D059_FONACOT_ARREARS_ASG_GRE_ITD
         ...
         (
            ...
            (
               ...
               to_arrears   = to_arrears - D059_FONACOT_ARREARS_ASG_GRE_ITD
...
IF SALDO_ACUMULADO > 0 /*(D059_FONACOT_ACCRUED_ASG_GRE_ITD <> 0 )*/ THEN
	(
	Saldo = SALDO_ACUMULADO /*D059_FONACOT_ACCRUED_ASG_GRE_ITD + dedn_amt*/
