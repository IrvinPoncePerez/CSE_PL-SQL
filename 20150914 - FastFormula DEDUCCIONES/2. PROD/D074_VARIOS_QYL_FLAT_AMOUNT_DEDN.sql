...
/* ===== Latest balance creation begin ==== */
          ...
          SOE_ytd = D074_VARIOS_QYL_ASG_GRE_YTD
          SOE_mtd = D074_VARIOS_QYL_ASG_GRE_MTD
...
/* ====  Entry ITD Check Begin ==== */
   ...
   IF ( D074_VARIOS_QYL_ACCRUED_ENTRY_ITD = 0 AND
        D074_VARIOS_QYL_ACCRUED_ASG_GRE_ITD <> 0 ) THEN
   (
      to_total_owed = -1 * D074_VARIOS_QYL_ACCRUED_ASG_GRE_ITD + dedn_amt
   )

   IF ( D074_VARIOS_QYL_ARREARS_ENTRY_ITD = 0 AND
        D074_VARIOS_QYL_ARREARS_ASG_GRE_ITD <> 0 ) THEN
   (
      to_arrears = -1 * D074_VARIOS_QYL_ARREARS_ASG_GRE_ITD
   )
...
/* ===== Arrears Section Begin ===== */
   ...
   ELSE
   (
      IF D074_VARIOS_QYL_ARREARS_ASG_GRE_ITD <> 0 THEN
      (
         to_arrears = -1 * D074_VARIOS_QYL_ARREARS_ASG_GRE_ITD
      )
   )
   ...
   (
      ...
      ELSE
      (
         total_dedn = dedn_amt + D074_VARIOS_QYL_ARREARS_ASG_GRE_ITD
         ...
         (
            ...
            (
               ...
               to_arrears   = to_arrears - D074_VARIOS_QYL_ARREARS_ASG_GRE_ITD
   ...
   (
      ...
      (
         dedn_amt = Total_Owed - Futuro1   /*IPONCE   18-SEP-2015*/
          ...
          to_total_owed = -1 * Futuro1      /*PONCE  18-SEP-2015*/
          STOP_ENTRY = 'Y'

          mesg = GET_MESG('PAY','PAY_MX_STOPPED_ENTRY',
                                  'BASE_NAME','D074_VARIOS_QYL')
       )
...
IF SALDO_ACUMULADO > 0 /*(D074_VARIOS_QYL_ACCRUED_ASG_GRE_ITD <> 0 )*/ THEN
	(
	Saldo = SALDO_ACUMULADO /*D074_VARIOS_QYL_ACCRUED_ASG_GRE_ITD + dedn_amt*/
