...
IF SALDO_ACUMULADO > 0  /*(D086_LLANTAS_DAÑADAS_ACCRUED_ASG_GRE_ITD <> 0 )*/ THEN   /*IPONCE  28-MAY-2015*/
	(
	Saldo =SALDO_ACUMULADO  /*D086_LLANTAS_DAÑADAS_ACCRUED_ASG_GRE_ITD + dedn_amt*/ /*IPONCE 28-MAY-2015*/
