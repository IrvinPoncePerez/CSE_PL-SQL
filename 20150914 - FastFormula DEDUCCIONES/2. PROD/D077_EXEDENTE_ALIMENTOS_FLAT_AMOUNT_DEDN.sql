...
/* ===== Latest balance creation begin ==== */
          ...
          SOE_ytd = D077_EXEDENTE_ALIMENTOS_ASG_GRE_YTD
          SOE_mtd = D077_EXEDENTE_ALIMENTOS_ASG_GRE_MTD
...
/* ====  Entry ITD Check Begin ==== */
   ...
   IF ( D077_EXEDENTE_ALIMENTOS_ACCRUED_ENTRY_ITD = 0 AND
        D077_EXEDENTE_ALIMENTOS_ACCRUED_ASG_GRE_ITD <> 0 ) THEN
   (
      to_total_owed = -1 * D077_EXEDENTE_ALIMENTOS_ACCRUED_ASG_GRE_ITD + dedn_amt
   )

   IF ( D077_EXEDENTE_ALIMENTOS_ARREARS_ENTRY_ITD = 0 AND
        D077_EXEDENTE_ALIMENTOS_ARREARS_ASG_GRE_ITD <> 0 ) THEN
   (
...
/* ===== Arrears Section Begin ===== */
   ...
   ELSE
   (
      IF D077_EXEDENTE_ALIMENTOS_ARREARS_ASG_GRE_ITD <> 0 THEN
      (
         to_arrears = -1 * D077_EXEDENTE_ALIMENTOS_ARREARS_ASG_GRE_ITD
      )
   )
      ...
      (
         ...
         (
            ...
            (
               ...
               to_arrears   = to_arrears - D077_EXEDENTE_ALIMENTOS_ARREARS_ASG_GRE_ITD
      ...
      (
         dedn_amt = Total_Owed - Futuro3   /*IPONCE  18-SEP-2015*/
          ...
          mesg = GET_MESG('PAY','PAY_MX_STOPPED_ENTRY',
                                  'BASE_NAME','D077_EXEDENTE_ALIMENTOS')
       )
...
IF SALDO_ACUMULADO > 0 /*(D077_EXEDENTE_ALIMENTOS_ACCRUED_ASG_GRE_ITD <> 0 )*/ THEN
	(
	Saldo = SALDO_ACUMULADO /*D077_EXEDENTE_ALIMENTOS_ACCRUED_ASG_GRE_ITD + dedn_amt*/
