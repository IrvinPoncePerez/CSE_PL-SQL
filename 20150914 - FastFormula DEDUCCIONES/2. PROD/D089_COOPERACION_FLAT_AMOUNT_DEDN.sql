...
/* ===== Latest balance creation begin ==== */
          ...
          SOE_ytd = D089_COOPERACION_ASG_GRE_YTD
          SOE_mtd = D089_COOPERACION_ASG_GRE_MTD
...
/* ====  Entry ITD Check Begin ==== */
   ...
   IF ( D089_COOPERACION_ACCRUED_ENTRY_ITD = 0 AND
        D089_COOPERACION_ACCRUED_ASG_GRE_ITD <> 0 ) THEN
   (
      to_total_owed = -1 * D089_COOPERACION_ACCRUED_ASG_GRE_ITD + dedn_amt
   )

   IF ( D089_COOPERACION_ARREARS_ENTRY_ITD = 0 AND
        D089_COOPERACION_ARREARS_ASG_GRE_ITD <> 0 ) THEN
   (
...
/* ===== Arrears Section Begin ===== */
   ...
   ELSE
   (
      IF D089_COOPERACION_ARREARS_ASG_GRE_ITD <> 0 THEN
      (
         to_arrears = -1 * D089_COOPERACION_ARREARS_ASG_GRE_ITD
      )
   )
      ...
      (
         ...
         (
            ...
            (
               ...
               to_arrears   = to_arrears - D089_COOPERACION_ARREARS_ASG_GRE_ITD
