...
IF SALDO_ACUMULADO > 0 /*(D079_FINAN_CALZADO_IND_ACCRUED_ASG_GRE_ITD <> 0 )*/ THEN    --IPONCE  28-MAY-2015
	(
	Saldo = SALDO_ACUMULADO /*D079_FINAN_CALZADO_IND_ACCRUED_ASG_GRE_ITD + dedn_amt*/ --IPONCE  28-MAY-2015
