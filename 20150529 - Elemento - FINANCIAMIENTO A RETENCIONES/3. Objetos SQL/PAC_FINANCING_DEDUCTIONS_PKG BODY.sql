CREATE OR REPLACE PACKAGE BODY PAC_FINANCING_DEDUCTIONS_PKG AS
    ...
    BEGIN
        ...
        LOOP
            var_row_num := detail.ROW_NUM;
            var_employment_subsidy := var_employment_subsidy + NVL(PAC_RESULT_VALUES_PKG.GET_DEDUCTION_VALUE(detail.ASSIGNMENT_ACTION_ID,
                                                                                                           'D055_ISPT',
                                                                                                           'Pay Value'), 
                                                                   0);                            
        END LOOP;
        ...
        RETURN var_average_employment_subsidy;
    END AVERAGE_EMPLOYMENT_TAX;
    


END PAC_FINANCING_DEDUCTIONS_PKG;
