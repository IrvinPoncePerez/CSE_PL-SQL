        SELECT /*+ USE_NL LEADING(PCS PAAF) */
               PAAF.PERSON_ID,
          ...
          FROM (SELECT DISTINCT /*+ USE_NL LEADING(PPA PTP PAA PPF) INDEX_JOIN(PTP PAY_PAYROLL_ACTIONS_FK8 PER_TIME_PERIODS_PK) INDEX_JOIN(PAA PAY_PAYROLL_ACTIONS_PK PAY_ASSIGNMENT_ACTIONS_N4) INDEX_JOIN(PPF PAY_PAYROLL_ACTIONS_N50 PAY_PAYROLLS_F_PK)*/
                       PAA.TAX_UNIT_ID,
