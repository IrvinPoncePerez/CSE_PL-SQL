...
--                       apps.PAC_RESULT_VALUES_PKG.GET_OTHER_VALUE(PAA.ASSIGNMENT_ACTION_ID,          'D058_INFONAVIT',           'Discount Value')     AS  VALOR_INFONAVIT,
                       ...
                       NVL(PAC_RESULT_VALUES_PKG.GET_INFORMATION_VALUE(PAA.ASSIGNMENT_ACTION_ID,    'Earnings Balance Adjustments', 'IDW Variable Basis Eligible Comp'),'0')   AS  DESPENSA_EXE,
