    ...
    */
    ...
    BEGIN
    	...
    	IF P_AREA = 'REPARTO' THEN
    		...
    		app_item_property.set_property('PAC_FUEL_EC_EFFICIENCIES.ATTRIBUTE5', ENABLED, PROPERTY_OFF);
    		app_item_property.set_property('PAC_FUEL_EC_EFFICIENCIES.ATTRIBUTE1', REQUIRED, PROPERTY_ON);
    		app_item_property.set_property('PAC_FUEL_EC_EFFICIENCIES.ATTRIBUTE6', REQUIRED, PROPERTY_ON);
    		app_item_property.set_property('PAC_FUEL_EC_EFFICIENCIES.CREATION_DATE', ENABLED, PROPERTY_OFF);
    	ELSIF P_AREA <> 'REPARTO' THEN
    		...
    		app_item_property.set_property('PAC_FUEL_EC_EFFICIENCIES.ATTRIBUTE5', ENABLED, PROPERTY_ON);
    		app_item_property.set_property('PAC_FUEL_EC_EFFICIENCIES.ATTRIBUTE1', REQUIRED, PROPERTY_OFF);
    		app_item_property.set_property('PAC_FUEL_EC_EFFICIENCIES.ATTRIBUTE6', REQUIRED, PROPERTY_OFF);
    		app_item_property.set_property('PAC_FUEL_EC_EFFICIENCIES.CREATION_DATE', ENABLED, PROPERTY_ON);
    		app_item_property.set_property('PAC_FUEL_EC_EFFICIENCIES.CREATION_DATE', REQUIRED, PROPERTY_ON);
    	END IF;
	  	...
	  	IF (VALIDATE_FORM() = TRUE) THEN
	  		...
	  		SET_BLOCK_PROPERTY('PAC_FUEL_EC_EFFICIENCIES',ONETIME_WHERE,'EFFICIENCY_ID='||:EFFICIENCY_ID);
				...
				EXECUTE_QUERY;
		  		...
		  		var_alert_button := show_alert('SAVE_MSG');
		 ...
		 ELSIF :AREA <> 'REPARTO' THEN
		 	...
		 	SELECT XRXD.RENDIMIENTO_ESPERA,
              ...
              INTO :EXPECTED_EFFICIENCY,
                ...
                FROM XXCALV_REND_X_DESTINO XRXD
              WHERE 1 = 1
                AND XRXD.GRUPO_UNIDAD IS NOT NULL
                AND XRXD.GRUPO_UNIDAD = :VEHICLE_ID
                AND NVL(XRXD.TIPO_CARGA, 0) = NVL(:ATTRIBUTE6, 0);
		   	   --AND XRXD.TIPO_CARGA = :ATTRIBUTE6
		   	   --AND :ATTRIBUTE7 BETWEEN XRXD.CANTIDAD_CAJAS AND XRXD.CANTIDAD_CAJAS_R;
