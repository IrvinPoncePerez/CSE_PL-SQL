CREATE OR REPLACE PACKAGE BODY PAC_VERIFY_CEDIS_PKG  AS
    ...
    BEGIN
        ...
        ELSIF   COLUMN_DESC = 'Transfer_Credit'             THEN    IF COLUMN_VAL = '01-0000-110723000001-00-0000-0000' THEN RETURN 'Y'; ELSE RETURN 'N'; END IF;
        ELSIF   COLUMN_DESC = 'Price_Variance'              THEN    IF COLUMN_VAL = '01-0801-840400000001-00-0000-0000' THEN RETURN 'Y'; ELSE RETURN 'N'; END IF;
        ELSIF   COLUMN_DESC = 'Receivable'                  THEN    IF COLUMN_VAL = '01-0000-110407000001-00-0000-0000' THEN RETURN 'Y'; ELSE RETURN 'N'; END IF;
        ELSIF   COLUMN_DESC = 'Payable'                     THEN    IF COLUMN_VAL = '01-0000-210203000001-00-0000-0000' THEN RETURN 'Y'; ELSE RETURN 'N'; END IF;
        ELSIF   COLUMN_DESC = 'Intransit_Inventory'         THEN    IF COLUMN_VAL = '01-0801-110701000001-00-0000-0000' THEN RETURN 'Y'; ELSE RETURN 'N'; END IF;
        ELSIF   COLUMN_DESC = 'Purchase_Price_Variance'     THEN    IF COLUMN_VAL = '01-0801-840400000001-00-0000-0000' THEN RETURN 'Y'; ELSE RETURN 'N'; END IF;
        ELSIF   COLUMN_DESC = 'Invoice_Price_Variance'      THEN    IF COLUMN_VAL = '01-0000-840100000001-00-0000-0000' THEN RETURN 'Y'; ELSE RETURN 'N'; END IF;
        ELSIF   COLUMN_DESC = 'Inventory_AP_Accrual'        THEN    IF COLUMN_VAL = '01-0000-210105000001-00-0000-0000' THEN RETURN 'Y'; ELSE RETURN 'N'; END IF;
        ELSIF   COLUMN_DESC = 'Encumbrance'                 THEN    IF COLUMN_VAL = '01-0000-999901000001-00-0000-0000' THEN RETURN 'Y'; ELSE RETURN 'N'; END IF;
        ELSIF   COLUMN_DESC = 'Sales'                       THEN    IF COLUMN_VAL = '01-0801-510101000001-00-0000-0000' THEN RETURN 'Y'; ELSE RETURN 'N'; END IF;
        ELSIF   COLUMN_DESC = 'Cost_of_Goods_Sold'          THEN    IF COLUMN_VAL = '01-0801-810100000001-00-0000-0000' THEN RETURN 'Y'; ELSE RETURN 'N'; END IF;
        ELSIF   COLUMN_DESC = 'Deferred_COGS_Account'       THEN    IF COLUMN_VAL = '01-0801-810100000001-00-0000-0000' THEN RETURN 'Y'; ELSE RETURN 'N'; END IF;
        ELSIF   COLUMN_DESC = 'Cost_Variance_Account'       THEN    IF COLUMN_VAL = '01-0000-610700000001-00-0000-0000' THEN RETURN 'Y'; ELSE RETURN 'N'; END IF;
        ...
        ELSIF   COLUMN_DESC = 'Receiving_Inventory'         THEN    IF COLUMN_VAL = '01-0000-110722000001-00-0000-0000' THEN RETURN 'Y'; ELSE RETURN 'N'; END IF;
        ELSIF   COLUMN_DESC = 'Clearing'                    THEN    IF COLUMN_VAL = '01-0000-210106000001-00-0000-0000' THEN RETURN 'Y'; ELSE RETURN 'N'; END IF;
