SELECT FUV1.USER_NAME                                       CREATED_BY,
       ...
       COLUMN_VAL,  
       PAC_VERIFY_CEDIS_PKG.VERIFY_STEP2(COLUMN_DESC, COLUMN_VAL, :P_ORG_INVENTORY_ID)  VALIDATION
  FROM (SELECT TO_CHAR(HOU.NAME)                     AS  "Name",
               ...
               TO_CHAR(LE.NAME)                      AS  "Default_Legal_Context",
               TO_CHAR(HOI2.ORG_INFORMATION5)        AS  "Operating_Unit_Short_Code",
               HOU.CREATED_BY,
               HOU.CREATION_DATE,
               HOU.LAST_UPDATED_BY,
         ...
         WHERE 1 = 1
           ...
           AND GL.LEDGER_ID = HOI2.ORG_INFORMATION3
