/*Codigo JRCA 13-dic-2010
    ...
    Modify date : 07 Jul 2014 04:00pm
*/
SELECT ac.check_id,
       ac.check_number,
       ac.check_date,
      ...
      DECODE(cba.currency_code
             ,'MXN'
             ,NVL(ac.base_amount,ac.amount),ac.amount)            amount,
      ...
      DECODE(:P_LEYENDA
             ...
             ,'SI'
             ,'PARA ABONO EN LA CUENTA DEL BENEFICIARIO') Nota  
 ...
 WHERE 1=1
    ...
    AND ac.BANK_ACCOUNT_NAME LIKE '%BANAMEX%'         --JRCA 13/DIC/2010
