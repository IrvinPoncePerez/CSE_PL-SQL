...
--                                                              ')');
    ...
    BEGIN
        ...
        IF var_validate = 0 THEN
            ...
            DECLARE
                ...
                CURSOR SKIP_SKIP_LIST (PP_PAYMENT_DATE      DATE, 
                                       PP_PERIOD_NAME       VARCHAR2) IS
                    SELECT ASM.PERSON_ID                    AS  PERSON_ID,
                           ASPS.PAYMENT_DATE                AS  EARNED_DATE,
                           ASPS.TIME_PERIOD_ID              AS  TIME_PERIOD_ID,
            ...
            BEGIN
                ...
                IF var_result = 'Y' THEN
                    ...
                    FOR detail_skip IN SKIP_SKIP_LIST(var_pp_payment_date, var_pp_period_name) LOOP
                        
                        var_result := 'N';
                        var_skip_count := var_skip_count + 1;
                        
                        FND_FILE.PUT_LINE(FND_FILE.LOG, 'PROCESANDO SKIP: ' || detail_skip.PAYROLL_RESULT_ID  || ','
                        ...
                        UPDATE ATET_SB_PAYMENTS_SCHEDULE    ASPS
                           SET ASPS.STATUS_FLAG = 'EXPORTED'
                         WHERE 1 = 1
                           AND ASPS.PAYMENT_SCHEDULE_ID = detail_skip.PAYMENT_SCHEDULE_ID;
                    ...
                    IF    var_result = 'Y' THEN
                        ...
                        FND_FILE.PUT_LINE(FND_FILE.OUTPUT, '*   DESCUENTOS NO EXPORTADOS    : ' || TO_CHAR(var_skip_count));
                        FND_FILE.PUT_LINE(FND_FILE.OUTPUT, '*');
                        FND_FILE.PUT_LINE(FND_FILE.OUTPUT, '********************************************************');
                ...
                IF var_result = 'Y' THEN
                    ...
                    IF    var_result = 'Y' THEN
                        ...
                        FND_FILE.PUT_LINE(FND_FILE.OUTPUT, '*');
                        FND_FILE.PUT_LINE(FND_FILE.OUTPUT, '*   '||GET_PARAMETER_VALUE(GET_SAVING_BANK_ID, 'LOAN_ELEMENT_NAME'));
                        FND_FILE.PUT_LINE(FND_FILE.OUTPUT, '*   DESCUENTOS EXPORTADOS SIN EJECUCION DE NOMINA    : ' || TO_CHAR(var_skip_count));
                        FND_FILE.PUT_LINE(FND_FILE.OUTPUT, '*');
                        FND_FILE.PUT_LINE(FND_FILE.OUTPUT, '********************************************************');
   ...
   BEGIN
    ...
    IS
        ...
        PAYMENT_AMOUNT_EXCEPTION        EXCEPTION;
        ...
        BEGIN
            ...
            IF P_PAYMENT_AMOUNT = (var_asps_payment_capital     + 
                                   var_asps_payment_interest    +
                                   var_asps_payment_interest_late) THEN
        ...
        ELSE
            RAISE PAYMENT_AMOUNT_EXCEPTION;
        END IF;
        
    EXCEPTION
        WHEN PAYMENT_AMOUNT_EXCEPTION THEN
            FND_FILE.PUT_LINE(FND_FILE.LOG, 'ERROR: NO COINCIDE EL MONTO ABONADO CON EL SALDO DEL PRESTAMO.');
            P_RETCODE := 2;
