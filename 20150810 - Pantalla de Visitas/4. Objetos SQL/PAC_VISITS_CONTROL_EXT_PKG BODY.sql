CREATE OR REPLACE PACKAGE BODY PAC_VISITS_CONTROL_EXT_PKG IS
    ...
    BEGIN
        ...
        XXCALV_UTILS_PKG.XXCALV_VOUT('^FO30,55^B3N,N,140,Y,Y^FD'||P_FOLIO||'^FS');   
        XXCALV_UTILS_PKG.XXCALV_VOUT('^FO60,220^AEN,25,10^FDDIA:^FS');
        ---
        XXCALV_UTILS_PKG.XXCALV_VOUT('^FO60,315^AEN,25,10^FD'||P_FOLIO||'^FS');
        ---
        XXCALV_UTILS_PKG.XXCALV_VOUT('^FO200,220^AEN,25,10^FDFOLIO:^FS');
        XXCALV_UTILS_PKG.XXCALV_VOUT('^FO440,220^AEN,25,10^FDTIPO:^FS');
        XXCALV_UTILS_PKG.XXCALV_VOUT('^FO70,260^AEN,40,20^FD'||P_FOLIO||'^FS');        
        XXCALV_UTILS_PKG.XXCALV_VOUT('^FO60,310^ADN,40,20^FD'||P_FOLIO||'^FS');         
        XXCALV_UTILS_PKG.XXCALV_VOUT('^FO210,260^AEN,70,22^FD'||SUBSTR(P_FOLIO,-6)||'^FS');
        XXCALV_UTILS_PKG.XXCALV_VOUT('^FO350,260^ADN,40,20^FD'||P_FOLIO||'^FS');      
        XXCALV_UTILS_PKG.XXCALV_VOUT('^FO350,310^ADN,40,20^FD'||P_FOLIO||'^FS');                 
        ...
        XXCALV_UTILS_PKG.XXCALV_VOUT('^FO25,435^A0N,40,40^FD'||P_FOLIO||'^FS');       
        XXCALV_UTILS_PKG.XXCALV_VOUT('^FO210,415^AEN,70,22^FD'||P_FOLIO||'^FS');    
