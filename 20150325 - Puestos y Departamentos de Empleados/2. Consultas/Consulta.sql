...
--           AND EXTRACT(YEAR FROM PAPF.EFFECTIVE_END_DATE) >= EXTRACT(YEAR FROM :CP_END_DATE)
 ...
 WHERE 1 = 1      
--   AND REG_PATRONAL = 'E7558691100'
-- and employee_number in (3786, 3766, 3777, 3778, 3811, 3818, 3784)
