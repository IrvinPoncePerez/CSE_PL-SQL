...
SELECT POPM.ORG_PAYMENT_METHOD_ID,
 ...
 WHERE 1 = 1
   ...
   AND POPM.ORG_PAYMENT_METHOD_NAME NOT LIKE '%PAGO%'
...
BEGIN
    ATET_SAVINGS_BANK_PKG.RETIREMENT_DISPERSION
        (
            P_ERRBUF            => P_ERRBUF,
            P_RETCODE           => P_RETCODE,
            P_YEAR              => 2016,
            P_MEMBER_NAME       => 'ASOCIACION DE TRABAJADORES Y EMPLEADOS DE TEHUACAN, S.C.',
            P_PAYMENT_METHOD_ID => 81
        );
END;
...
SELECT *
  FROM ATET_RETIREMENT_DISPERSION_TB;
